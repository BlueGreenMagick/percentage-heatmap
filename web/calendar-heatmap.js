function calendarHeatmap() {
    ...
    chart.startDate = function (value) {
      ...
      yearAgo = value;
      now = moment(value).endOf('day').add(1, 'year').subtract(1, 'day').toDate();
      return chart;
    };
    ...
    function chart() {
      ...
      function tooltipHTMLForDate(d) {
        ...
        var count = countForDate(d);
        return '<span><strong>'+ pluralizedTooltipUnit(count).replace("%n", count) + '</strong> ' + locale.on + ' ' + dateStr + '</span>';
      }
